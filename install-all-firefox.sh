...
default_versions_current="19.0"
default_versions_past="2.0.0.20 3.0.19 3.5.19 3.6.28 4.0.1 5.0.1 6.0.2 7.0.1 8.0.1 9.0.1 10.0.2 11.0 12.0 13.0.1 14.0.1 15.0.1 16.0.1 17.0.1 18.0.2"
...
get_associated_information(){
  ...
  case $1 in
    ...
    18.0.2)
      ...
      ;;
    19.0)
      ftp_root="ftp://ftp.mozilla.org/pub/mozilla.org/firefox/releases/19.0/"
      dmg_file="Firefox 19.0.dmg"
      sum_file="MD5SUMS"
      sum_file_type="md5"
      binary="firefox"
      short_name="fx19"
